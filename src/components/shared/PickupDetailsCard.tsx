...
export default function PickupDetailsCard({ buttonLabel, buttonIcon: ButtonIcon, onPress, status = "Ongoing" }: Props) {
  return (
    <SafeAreaView className="flex-1 bg-[#F8F6FA]" edges={['top']}>
      ...
      >
        ...
        <TouchableOpacity
          onPress={onPress}
          className="bg-[#652D8B] py-3 rounded-xl flex-row items-center justify-center gap-2 mb-4 mx-1"
        >
