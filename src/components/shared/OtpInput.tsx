    ...
    return (
      <View className="flex-row gap-2.5">
        {digits.map((digit, i) => {
          ...
          const borderColor =
            isFocus || hasDigit ? "border-[#652D8B]" : "border-[#652D8B]";
          const bg = isFocus || hasDigit ? "bg-[#FFFFFF]" : "";
          ...
          return (
            <TextInput
              ...
              className={`w-12 h-14 rounded-lg border-[.5px] ${borderColor} ${bg}  text-center text-3xl font-bold text-[#652D8B] sm:w-16 sm:h-20 md:w-20 md:h-24`}
              style={{
